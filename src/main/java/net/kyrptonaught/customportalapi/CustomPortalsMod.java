...
public class CustomPortalsMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        //CustomPortalBuilder.beginPortal().frameBlock(Blocks.GLOWSTONE).destDimID(new Identifier("the_nether")).lightWithWater().setPortalSearchYRange(126, 256).tintColor(46, 5, 25).registerPortal();
